...
int main(int argc, char* argv[]){
    ...
    if (argc == 2 && strcmp(argv[1],ayuda) == 0) //Muestro la ayuda al usuario
    {
        ...
        printf("\nleer del archivo de asistencia y enviar los datos a un proceso llamado 'Socios' que los procesará");
        printf("\nPara poder ejecutar este programa, debe correr primero el proceso 'Socios'");
